...
export const HeroBlock: React.FC<HeroBlockProps> = ({
  ...
  return (
    <Section spacing="xl" className={cn('bg-linear-to-b from-blue-50 to-white', className)}>
...
export const heroExamples = [
  {
    ...
    subtitle: 'Comprehensive analysis of sustainable development projects across 45 countries',
    media: { type: 'image' as const, src: '/images/hero-map.jpg', alt: 'Global project map' },
    kpis: [
      { label: 'Projects Completed', value: '1,247', change: '+23% YoY', icon: '📊' },
      { label: 'Countries Served', value: '45', icon: '🌍' },
      { label: 'Investment Value', value: '$2.4B', change: '+15%', icon: '💰' },
      { label: 'Beneficiaries', value: '12M', icon: '👥' },
    ],
    primaryCTA: { label: 'Read Full Report', href: '#report', variant: 'primary' as const },
    secondaryCTA: { label: 'View Data', href: '#data', variant: 'secondary' as const },
  },
  {
  ...
  },
  {
    ...
    media: { type: 'video' as const, src: '/videos/energy-transition.mp4', poster: '/images/energy-poster.jpg' },
    kpis: [
